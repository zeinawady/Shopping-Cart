...
listCart.innerHTML+=`
 <div class="item d-flex justify-content-between align-items-center my-4">
                    <div class="image">
                        <img src="${choosenItem.imgUrl}" alt="product" width="40px">
                    </div>
                    <div class="name">${choosenItem.title}</div>
                    <div class="price">$${choosenItem.price}</div>
                    <div class="quantity">
                        <span><i class="fa-solid fa-circle-plus iconAdd"></i></span>
                        <span>0</span>
                        <span><i class="fa-solid fa-circle-minus iconAdd"></i></span>
                    </div>
                </div>
`
sum.innerHTML+=choosenItem.
}
