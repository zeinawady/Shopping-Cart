...
function addToCart(id) {
    ...
    itemDiv.innerHTML = `
        ...
        <button class="trashIcon" style="cursor: pointer;" onclick="deleteItem(${chosenItem.id})"><i class=" fa-solid fa-trash"></i></button>
    `;
...
function deleteItem(id){
    let deletedItem=products.find((item)=> item.id===id);
    let parentItem=deletedItem.parent;
    parentItem.remove(deletedItem);
}